...
import { idParamSchema, requestUpdateBodySchema, resolveBodySchema, } from './emergencies.schemas.js';
import * as svc from './emergencies.service.js';
const router = Router();
router.use(authGuard, roleGuard('admin'));
router.post('/:id/request-update', adminActionLimiter, validateRequest({ params: idParamSchema, body: requestUpdateBodySchema }), async (req, res, next) => {
    try {
